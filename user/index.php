            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="product-sales-chart">
                    ...
                    <center>
                        ...
                        <h4>Sistem Arsip Digital PED</h4>
                        <h4>(Planning, Engineering, & Deployment)</h4>
                        <h5>Telkom Indonesia Regional 1 Sumatera</h5>
                ...
                <div class="product-sales-chart">
                   ...
                   <div class="portlet-title">
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="caption pro-sl-hd">
                                    <span class="caption-subject"><b>Grafik download arsip</b></span>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                <div class="actions graph-rp graph-rp-dl">
                                    <p>Grafik jumlah download arsip perhari selama sebulan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <ul class="list-inline cus-product-sl-rp">
                        <li>
                            <h5><i class="fa fa-circle" style="color: skyblue;"></i>Jumlah Download</h5>
                        </li>
                    </ul>
                    <div id="grafik-unduh">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                ...
                <div class="single-cards-item">
                    ...
                    <div class="single-product-text">
                        ...
                        <h4><a class="cards-hd-dn" href="profil.php"><?php echo $s['user_nama']; ?></a></h4>
                        <h5>user</h5>
                        <p class="ctn-cards">Pengelolaan arsip jadi lebih mudah dengan sistem arsip digital PED.</p>
                    </div>
                </div>
