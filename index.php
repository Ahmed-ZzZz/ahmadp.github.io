    ...
    <body>
        ...
        <div class="logo">
            <img src="assets/img/logo/loder2.png" alt="Logo Website">
        </div>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div style="margin-top: 140px;">
                            <h1>Sistem Arsip Digital PED</h1>
                            <p>(Planning, Engineering, & Deployment)</p>
                            <p>Telkom Indonesia Regional 1 Sumatera</p>
