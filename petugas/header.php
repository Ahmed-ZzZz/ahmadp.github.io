    ...
    <div class="left-sidebar-pro">
        <nav id="sidebar" class="">
            <div class="sidebar-header">
                <a href="index.php"><img class="main-logo" src="../assets/img/logo/logos.png" alt="" /></a>
                <strong><a href="index.html"><img src="../assets/img/logo/logos.png" alt="" /></a></strong>
            </div>
                                    ...
                                    <div class="col-lg-5 col-md-6 col-sm-12 col-xs-12">
                                        <div class="header-top-menu tabl-d-n">
                                            <ul class="nav navbar-nav mai-top-nav">
                                                <li class="nav-item"><a href="#" class="nav-link">Sistem Arsip Digital PED/TREG-1</a></li>
                                            </ul>
                                        </div>
                                    </div>
